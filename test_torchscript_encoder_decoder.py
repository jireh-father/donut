...
def main(args, left_argv):
    ...
    start = time.time()
    ret = encoder(torch.rand(1, 3, config.input_size[0], config.input_size[1]).to(torch.bfloat16))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_model_path', default='D:\\result\\tableocr\\android/donut.ptl', type=str)
    parser.add_argument('--decoder_model_path', default='D:\\result\\tableocr\\android/donut.ptl', type=str)
